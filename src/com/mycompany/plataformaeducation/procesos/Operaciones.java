...
public class Operaciones {
    ...
    public static List<Pregunta> seleccionarContenido(Estudiante estudiante) {
        ...
        if (estudiante.getNivel().trim().equals("Nivel Básico")) {
            actividad.add(new Pregunta("¿Cuánto es 2 + 2? Valor numerico", "4", "Aritmética básica"));
            ...
            actividad.add(new Pregunta("Resuelve para x: 2x + 5 = 15 .Valor numerico", "5", "Álgebra básica"));
            ...
            actividad.add(new Pregunta("Resuelve para x: 3x - 5 = 6x - 23 .Valor numerico", "6", "Álgebra básica"));
